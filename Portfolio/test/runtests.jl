...
# !!! Main.UserApp is configured as an alias for Main.Portfolio and you might encounter it in some tests
using Main.Portfolio, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Portfolio tests" begin
  @includetests ARGS
end
